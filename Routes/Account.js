...
module.exports = function(app){
                    ...
                    bcrypt.hash(req.body.Password, salt, function(err, hash) {
                        if(err){
                            ...
                            newUser.save(function(err, data){
                                console.log(data);
                                if(err){
                                    console.log("Mongo save user error");
    ...
    app.post("/login", function(req, res){
        ...
        User.findOne({Username:req.body.Username}, function(err, data){ //data chinh la user tim duoc -> function(err,[ket qua cua ve truoc findOne]), findOne khong run duoc khi data co noi dung tieng Viet 
            if(err){
    ...
    app.post("/verifyToken", function(req, res){
        Token.findOne({Token:req.body.Token, State:true}).select("_id").lean().then(result=>{//if ton tai id (if id exist)
            if(!result){
